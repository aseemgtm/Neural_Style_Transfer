...
def uploadImage(request):
    ...
    user.save();
    return render(request, 'input1.html')
def uploadImage1(request):
    print("Request Handling............")
    pict1 = request.FILES['image'];
    from .models import User1
    user1 = User1(pic1 = pict1)
    user1.save();
    return render(request, 'input2.html')
def output(request):
    from .models import User1
    users1=User1.objects.all();
    p1=users1[len(users1)-1].pic1
    print(p1.url)
    from .models import User
    ...
    def NST(content_name, style_name):
        ...
        output = 'C:\\Users\\HP\\Minor_project\\Minorproject\\static\\output\\' + content_name
    ...
    print(x[1])
    y=x[1].split("content/")
    return render(request, 'output.html',{'pi':x[1],'pi1':y[1]})
